...
from .views import UserRegisterView,VerifyEmailOTPView,CustomTokenObtainPairView,CustomTokenRefreshView,LogoutView,ResendOTPView,GoogleLoginView,PasswordResetRequestView,PasswordResetConfirmView
